...
class Blogs extends React.Component {
    render () {
        return (
            <div className="p-10 pt-10 pb-40 items-center" id="blogs">
                <h2 className="text-3xl text-black font-semibold pb-10">Blogs</h2>
                <p className="projects-description pb-10 items-center">Here a few articles I have written on various topics, and some books I have authored. <br />
